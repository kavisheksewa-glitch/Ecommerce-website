...
// ⚠️ FIX: Render ka network kabhi kabhi smtp.gmail.com ko IPv6 address par
// resolve karta hai, jo Render route nahi kar pata — isse "ENETUNREACH" error
// aata hai. Yeh line Node ko hamesha IPv4 address pehle try karne ko kehti hai.
...
const transporter = nodemailer.createTransport({
  host: "smtp.gmail.com", // ⚠️ FIX: "service: gmail" shorthand ki jagah explicit host/port
  port: 465,
  secure: true, // true for port 465 (SSL), false for port 587 (STARTTLS)
  family: 4, // ⚠️ FIX: socket ko force IPv4 use karne do
  auth: {
...
// ⚠️ CRITICAL: function ko DIRECTLY export karo, object mein wrap mat karo.
// require("../utils/SendEmail") ko function hi milna chahiye, taaki
// sendOtpEmail(...) seedha call ho sake jahan bhi import kiya jaye.
