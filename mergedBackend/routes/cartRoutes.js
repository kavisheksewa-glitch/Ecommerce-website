...
// const router = express.Router();
// const Cart = require("../models/Cart");
// const Notification = require("../models/Notification"); // 👈 Notification model import kiya gaya hai
...
//  * /api/shawls/cart/add:
//  *  post:
//  *   summary: Add an item to the cart and trigger a notification
//  *   description: Adds a product to the user's cart or increments quantity if it already exists. Creates a notification. Requires authentication.
//  *   tags: [carts Product]
//  *   requestBody:
//  *    required: true
//  *    content:
...
//  *    responses:
//  *     '200':
//  *      description: Cart updated with incremented quantity and notification sent
//  *     '201':
//  *      description: New item successfully added to cart and notification sent
//  *     '401':
//  *      description: Unauthorized (User is guest or not logged in)
//  *     '500':
//  *      description: Internal server error
...
//       // 🔔 Notification create karein quantity update hone par
//       try {
//         await Notification.create({
//           userId: userId,
//           title: "Cart Update 🛒",
//           message: `Your cart was updated for "${title || 'Item'}".`,
//           type: "cart",
//           read: false,
//           time: new Date()
//         });
//       } catch (notifErr) {
//         console.error("Cart notification error:", notifErr.message);
//       }
...
//     // 🔔 Notification create karein naya item add hone par
//     try {
//       await Notification.create({
//         userId: userId,
//         productId: productId,
//         title: "Added to Cart 🛒",
//         message: `"${title || 'A new product'}" has been successfully added to your cart.`,
//         type: "cart",
//         read: false,
//         time: new Date()
//       });
...
//  *   description: Customer cart and product management APIs
//  */
