...
//  * /api/shawls/add:
//  *  post:
//  *   summary: Add Item to Wishlist and trigger notification
//  *   description: Adds a product to the user's wishlist if it doesn't already exist and creates a notification.
//  *   tags: [Customer whislist Products]
//  *   requestBody:
//  *    required: true
//  *    content:
...
//  *   responses:
//  *    '201':
//  *     description: Added to wishlist successfully with notification
//  *     content:
//  *      application/json:
//  *       schema:
//  *        type: object
...
//     // 🔔 Wishlist Notification Create Karein (ProductId ke sath)
//     try {
//       await Notification.create({
//         userId: userId,
//         productId: productId, // 👈 Yahan productId properly save ho rahi hai
...
//         time: new Date()
//       });
//       console.log("✅ Wishlist Notification created successfully for userId:", userId);
//     } catch (notifErr) {
//       console.error("❌ Error creating wishlist notification:", notifErr);
//     }
...
//  * @swagger
//  * tags:
//  *   name: Customer wishlist Products
//  *   description: customer wishlist product management APIs
//  */
...
//  *     summary: Get Wishlist Items by User ID
//  *     description: Retrieves all wishlist items associated with a specific user ID.
//  *     tags: [Customer wishlist Products]
//  *     parameters:
//  *       - in: path
//  *         name: userId
//  *         required: true
