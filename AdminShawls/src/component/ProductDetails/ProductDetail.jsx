          ...
          <div className="row g-4 align-items-center">
            ...
            <div className="col-12 col-md-6 col-lg-5">
              <div className="position-relative overflow-hidden rounded-3 bg-light text-center border">
                {product.brandLogo && (
                  <div
                    className="position-absolute top-0 start-0 m-3 rounded-circle overflow-hidden bg-white shadow-sm d-flex align-items-center justify-content-center"
                    style={{ width: "56px", height: "56px", zIndex: 2, border: "1.5px solid #fff" }}
                    title="Brand Logo"
                  >
                    <img
