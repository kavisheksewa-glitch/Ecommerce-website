...
function WeddingGifts() {
    ...
    fetch(
      ...
      .then((data) => {
        if (data.success && Array.isArray(data.cart)) {
          setCartProductIds(
            data.cart.map((item) => String(item.productId))
          );
        }
      })
      .catch((err) =>
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        if (Array.isArray(res.data)) {
          const dbProducts = res.data
            .filter(
              (p) => p.category === "weddingGift Shawls"
            )
            .map((p) => {
          ...
          const staticWithPrice = WeddingShawls.map(
            (item) => ({
              ...item,
              priceNum: Number(
      ...
      .catch((err) =>
        console.error(
          "Error fetching live wedding products:",
          err
        )
      );
  ...
  const getProcessedProducts = (list) => {
    let filtered = list.filter((item) => {
      ...
      const matchesPrice =
        item.priceNum <= Number(priceFilter);

      const activeMaterials = Object.keys(
        selectedMaterials
      ).filter(
      ...
      const matchesMaterial =
        ...
        activeMaterials.some((mat) =>
          item.fabric
            ?.toLowerCase()
            .includes(mat.toLowerCase())
        );
  ...
  const displayedWeddingShawls =
    getProcessedProducts(weddingShawls);
    ...
    <div className="Customer_container1 bg-light pb-5">
      ...
      {shareProduct && (
        ...
        >
          ...
          >
            ...
            <button
              className="btn btn-dark mb-2 btn-sm w-100"
              onClick={copyLink}
            >
      ...
      <div className="mb-4">
        ...
        >
          ...
          >
            <h1 className="fw-bold display-6 fst-italic text-white">
              Wedding Gifts Collection
            </h1>

            <p className="text-light opacity-95 small mb-3">
              Make weddings memorable with our grand
              and elegant traditional shawls. Specially
              curated bridal and groom collections with
              luxury packaging.
            </p>

            <button
              onClick={() => navigate("/customer")}
              className="btn btn-sm px-4 py-2 fw-bold shadow-sm bg-white text-dark"
              style={{
                borderRadius: "6px",
              }}
            >
      ...
      <div className="container my-3 text-center">
        ...
        >
          ...
          <input
            ...
            className="form-control w-100 shadow-sm Customer_wedding-search"
            style={{
        ...
        <div className="row">
          ...
          <div className="col-lg-3 mb-4">
            ...
            <div className="d-block d-lg-none mb-2">
              <button
                className="btn w-100 d-flex justify-content-between align-items-center py-2 text-white Customer_mobile-filter-btn"
                type="button"
                onClick={() =>
          ...
          <div className="col-lg-9">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3 bg-white p-2 px-3 rounded shadow-sm border Customer_sort-box">

              <span className="text-muted small">
                Showing 1–
                {displayedWeddingShawls.length}{" "}
                products
              </span>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="Customer_card card h-100 border-0 shadow-sm d-flex flex-column justify-content-between p-2 position-relative">
                          ...
                          {/* ================= CARD BODY ================= */}
                          <div className="card-body Customer_card-body px-2 py-2 d-flex flex-column justify-content-between">
                            ...
                            <div>
                              ...
                              <p className="text-muted small mb-2 Customer_card-desc">
                                {item.description}
                              </p>

                              <div className="d-flex align-items-center gap-2 mb-2 Customer_price-row">

                                <span className="fw-bold text-danger Customer_price-main">
                                  {item.price}
                                </span>

                                {item.originalPrice && (
                                  <span className="text-decoration-line-through text-muted Customer_price-original">
                                    {
                                      item.originalPrice
                                    }
                                  </span>
      ...
      {/* ================= FEATURES ================= */}
      <div className="container my-5 Customer_features-container">

        <div className="bg-white p-3 rounded shadow-sm border d-flex flex-wrap justify-content-around text-center gap-3 Customer_features-box">

          <div className="d-flex align-items-center gap-2 Customer_feature-item">
