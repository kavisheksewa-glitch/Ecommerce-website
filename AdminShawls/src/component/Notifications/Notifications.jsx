...
//     try {
//       const response = await fetch(`http://localhost:5000/api/customer/notifications/${userId}`);
...
//   const handleMarkAsRead = async (id) => {
//     try {
//       const response = await fetch(`http://localhost:5000/api/customer/notifications/read/${id}`, {
//         method: "PUT",
//       });
//       if (response.ok) {
//         setNotifications(
...
//     if (!userId) return;
//     try {
//       const response = await fetch(`http://localhost:5000/api/customer/notifications/clear/${userId}`, {
//         method: "DELETE",
//       });
//       if (response.ok) {
//         setNotifications([]);
...
function Notifications() {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/customer/notifications", {
        headers: {
  ...
  const handleMarkAsRead = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:5000/api/customer/notifications/read/${id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`, // ✅ pehle yeh missing tha
  ...
  const handleClearAll = async () => {
    if (!token) return;
    try {
      const response = await fetch("http://localhost:5000/api/customer/notifications/clear", {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`, // ✅ pehle yeh missing tha
        },
