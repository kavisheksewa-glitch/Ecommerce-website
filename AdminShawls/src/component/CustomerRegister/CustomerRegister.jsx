...
function CustomerRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://ecommerce-website-ggui.onrender.com/api/customer/register", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        // ✅ Register ho gaya, ab email verify karne ke liye bhejo
        // (backend already verification OTP email pe bhej chuka hai)
