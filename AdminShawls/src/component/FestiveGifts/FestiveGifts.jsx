...
//   useEffect(() => {
//     // 1. Fetch Database Products and Merge with Static FestiveShawls
...
//           setFestiveShawls([...FestiveShawls, ...dbProducts]);
//         }
//       })
...
//           style={{ 
//             backgroundImage: `url(${festiveBgImage})`,
...
//               <span className="text-muted small">Showing 1–{festiveShawls.length} products</span>
...
//                               </button>
//                             ) : (
//                               <button onClick={() => handleAddToCart(item)} className="btn btn-dark btn-sm w-50 fw-semibold text-white" style={{ fontSize: "0.75rem", backgroundColor: "#20af33", border: "none", borderRadius: "6px" }}>
//                                 Add to Cart
//                               </button>
//                             )}
//                           </div>
...
//           <div className="col-lg-9">
//             <div className="d-flex justify-content-between align-items-center mb-3 bg-white p-2 px-3 rounded shadow-sm border">
//               <span className="text-muted small">Showing 1–{displayedFestiveShawls.length} products</span>
//               <select className="form-select form-select-sm w-auto">
//                 <option>Sort By: Newest First</option>
//                 <option>Price: Low to High</option>
//                 <option>Price: High to Low</option>
...
//                   <p className="text-muted fs-5">No festive shawls found matching your search.</p>
//                 </div>
//               )}
//             </div>
//           </div>
...
//   useEffect(() => {
//     // 1. Fetch Database Products and Merge with Static FestiveShawls uniquely
//     axios.get("http://localhost:5000/api/seller/products/public")
//       .then((res) => {
//         if (Array.isArray(res.data)) {
//           const dbProducts = res.data
...
//       {/* Top Banner Box (Original Position restored) */}
//       <div className="mb-4">
//         <div 
//           className="p-4 p-md-5 text-white rounded position-relative overflow-hidden d-flex align-items-center justify-content-between shadow-sm Customer_festive-banner" 
