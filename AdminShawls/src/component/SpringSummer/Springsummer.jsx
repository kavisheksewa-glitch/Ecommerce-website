...
//   const [allProducts, setAllProducts] = useState([...springShawls]);
...
//           setAllProducts([...springShawls, ...dbProducts]);
//         }
//       })
...
//       <img src={image111} alt="Kavi Shawls Banner" className="Customer_hero-image w-100" />
...
//           <input
//             type="text"
//             placeholder="Search spring summer shawls..."
//             value={searchQuery}
...
//               <p className="text-muted fs-5">No spring summer shawls found matching your search.</p>
//             </div>
//           )}
//         </div>
//       </div>
...
//                   />
//                   <label className="form-check-label small" htmlFor="fabricAllSpring">
//                     All
//                   </label>
//                 </div>
//                 {fabrics.map((fab, idx) => (
...
//                     />
//                     <label className="form-check-label small" htmlFor={`fabricSpring-${idx}`}>
//                       {fab}
//                     </label>
//                   </div>
//                 ))}
...
function Springsummer() {
  ...
  // ✅ ADD TO CART — /api/customer/cart/add
  const handleAddToCart =async (product) => {
   const token = localStorage.getItem("token");
      if (!token) {
