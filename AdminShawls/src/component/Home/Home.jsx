...
//           const formattedDbProducts = res.data.map((p) => ({
//             id: p._id,
//             title: p.productName,
...
//   const displayedHomeShawls = [...homeShawls, ...dbProducts];
//   const displayedAllShawls = [...shawls, ...dbProducts];
...
//         "http://localhost:5000/api/shawls/cart/add",
//         {
//           method: "POST",
//           headers: {
...
//           >
//             <span>
//               🍪 We use cookies to enhance your user
...
//             const isWishlisted =
//               wishlistProductIds.includes(productIdStr);
...
//   // COMBINED LISTS FOR DISPLAY
//   //const displayedHomeShawls = [...homeShawls, ...dbProducts];
//   const displayedHomeShawls = [...dbProducts];
//   const displayedAllShawls = [...shawls, ...dbProducts];
...
//     // Sort and filter: matching products go to the top
...
//           className="form-control w-100 mx-auto shadow-sm"
//           style={{
//             padding: "10px 15px",
//             borderRadius: "8px",
