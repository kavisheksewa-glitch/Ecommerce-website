...
// import luxuryBgImage from "../../assets/image.png";
// import { LuxuryShawls } from "../../data/shawls"; // Importing the LuxuryShawls array
...
//   const [luxuryShawls, setLuxuryShawls] = useState([...LuxuryShawls]); // State for luxury shawls
...
//   useEffect(() => {
//     // 1. Fetch Database Products and Merge with Static LuxuryShawls
...
//           setLuxuryShawls([...LuxuryShawls, ...dbProducts]);
         
//         }
//       })
//       .catch((err) => console.error("Error fetching live luxury products:", err));
...
//                 <div className="form-check small mb-1"><input className="form-check-input" type="checkbox" defaultChecked /><label className="form-check-label">Luxury Hampers</label></div>
...
//               <span className="text-muted small">Showing 1–{luxuryShawls.length} products</span>
...
//   const displayedLuxuryShawls = getProcessedProducts(luxuryShawls);
...
//           <div className="col-lg-9">
//             <div className="d-flex justify-content-between align-items-center mb-3 bg-white p-2 px-3 rounded shadow-sm border">
//               <span className="text-muted small">Showing 1–{displayedLuxuryShawls.length} products</span>
//               <select className="form-select form-select-sm w-auto">
//                 <option>Sort By: Newest First</option>
//                 <option>Price: Low to High</option>
//                 <option>Price: High to Low</option>
...
//                   <p className="text-muted fs-5">No luxury gift sets found matching your search.</p>
//                 </div>
//               )}
//             </div>
//           </div>
...
//   const [shareProduct, setShareProduct] = useState(null);
//   const [cartProductIds, setCartProductIds] = useState([]);
//   const [luxuryShawls, setLuxuryShawls] = useState([...LuxuryShawls]); 
//   const [wishlistProductIds, setWishlistProductIds] = useState([]);
//   const [priceFilter, setPriceFilter] = useState(8000);
//   const [searchQuery, setSearchQuery] = useState("");
...
//               ) : (
//                 <div className="col-12 text-center py-5">
//                   <p className="text-muted fs-5">No luxury gift sets found matching your search or price range.</p>
//                 </div>
//               )}
//             </div>
//           </div>
