...
//   // Global Cart IDs Fetching (Endpoint check kar lein ki backend me kya hai)
//   useEffect(() => {
//     fetch(`http://localhost:5000/api/cart/${userId}`) // Agar backend me /api/cart hai toh yeh rakhein
//       .then(async (res) => {
...
//   // Global Add To Cart Function (sellerId add kar diya hai)
...
//           quantity: 1,
//           sellerId: product.sellerId || product.seller || "default_seller_id" // 👈 Yeh sabse zaroori hai
//         }),
//       });
