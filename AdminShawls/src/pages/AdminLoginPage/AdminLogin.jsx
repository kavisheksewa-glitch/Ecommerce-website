...
function AdminLogin() {
  ...
  return (
    <>
      {/* Yeh CSS Bootstrap ke default focus shadow ko hatane ke liye hai */}
      <style>
        {`
          .custom-input:focus {
            box-shadow: none !important;
            border-color: #ced4da !important; /* Aap chahein toh border ka color bhi yahan control kar sakte hain */
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-3">
              ...
              <div className="input-group">
                ...
                <input
                  type="email"
                  className="form-control border-start-0 ps-0 bg-light custom-input"
