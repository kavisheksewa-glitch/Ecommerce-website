...
//     { title: "Total Orders", value: "356", change: "+8.2%", isPositive: true, icon: <FaShoppingCart /> },
...
//     { id: "#KS-104", customer: "Neha Gupta", product: "Traditional Stole", amount: "₹1,500", status: "Cancelled" },
//   ];

//   // Search filter logic for recent orders
...
//             </li>
//             <li className="nav-item">
//               <Link to="/admin/products" className="nav-link text-white py-2 px-3 rounded">
//                 🛍️ Manage Products
//               </Link>
//             </li>
//             <li className="nav-item">
...
//               <div className="input-group shadow-sm" style={{ width: "100%", maxWidth: "250px" }}>
...
//                 />
//               </div>
//               <Link to="/admin/products/add" className="btn text-white fw-semibold shadow-sm d-flex align-items-center justify-content-center gap-2 text-decoration-none" style={{ backgroundColor: "#064e3b" }}>
...
//                       <tr key={index}>
//                         <td className="fw-semibold" style={{ color: "#064e3b" }}>{order.id}</td>
...
//                             order.status === "Processing" ? "bg-info text-dark" : "bg-danger"
//                           }`}>
//                             {order.status}
//                           </span>
//                         </td>
