...
//   const fetchSellers = async () => {
//     try {
//       // ✅ Corrected path based on server.js
//       const response = await fetch("http://localhost:5000/api/seller/auth");
//       const data = await response.json();
...
//     try {
//       // ✅ Corrected path matching sellerAuthRoutes
//       const response = await fetch(`http://localhost:5000/api/seller/auth/status/${sellerId}`, {
//         method: "PUT",
//         headers: {
...
//   // Run fetchSellers on component mount
//   useEffect(() => {
//     fetchSellers();
//   }, []);
...
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${adminToken}`,   // ✅ Yeh line add ki
//         },
//         body: JSON.stringify({ status: newStatus }),
//       });
...
function AdminSellers() {
  ...
  // ✅ FIX: adminToken ko component ke top-level pe define kiya
