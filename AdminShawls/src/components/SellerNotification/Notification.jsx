...
//         // Token ko HTTP-only cookies ya memory se lein (agar token localStorage me store hai to sirf token auth ke liye use ho raha hai, seller ID localStorage se nahi utha rahe)
...
//       await axios.put(`http://localhost:5000/api/seller/notifications/${id}/read`, {}, {
//         headers: {
//           Authorization: `Bearer ${token}`
//         }
//       });

//       // UI se us notification ko turant hata dein
