...
//       setEditForm({ ...editForm, brandLogo: e.target.files[0] });
//     } else {
//       setEditForm({ ...editForm, [e.target.name]: e.target.value });
//     }
//   };
...
//         formData.append("productImage", editForm.productImage);
//       }
//       if (editForm.brandLogo) {
//         formData.append("brandLogo", editForm.brandLogo);
//       }
...
//           const rawLogo = product.brandLogo || "";
//           const prodLogo = rawLogo.startsWith("http")
//             ? rawLogo
//             : rawLogo
//             ? `http://localhost:5000/${rawLogo.replace(/\\/g, "/")}`
//             : "";
...
//                       style={{ width: "100px", height: "100px", objectFit: "cover" }}
//                     />
//                     {/* Brand Logo Display on Card */}
//                     {(prodLogo || (editForm.brandLogo && editingId === prodId)) && (
//                       <div className="mt-2">
//                         <img
//                           src={editForm.brandLogo && editingId === prodId ? URL.createObjectURL(editForm.brandLogo) : prodLogo}
//                           alt="Brand Logo"
...
//                       <label className="form-label small fw-bold mb-1">Change Brand Logo:</label>
//                       <input
//                         type="file"
//                         className="form-control form-control-sm mb-2"
//                         name="brandLogo"
...
function ManageProducts() {
  ...
  const fetchSellerBrand = async () => {
    ...
    try {
      const res = await axios.get(`http://localhost:5000/api/seller/auth/${sellerId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      setSellerBrand({
